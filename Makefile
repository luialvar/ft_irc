...
# Server sources
SRCS := main.cpp Server.cpp Client.cpp Channel.cpp parser.cpp ModeCommand.cpp JoinCommand.cpp InviteCommand.cpp PartCommand.cpp PrivmsgCommand.cpp utils.cpp
OBJS := $(SRCS:.cpp=.o)
